...
# Red team
import paintwars_team_Siham # importer votre code
get_name_red_team = paintwars_team_Siham.get_team_name # mettre ici votre fonction get_team_name
step_red_team = paintwars_team_Siham.step # mettre ici votre fonction step
